  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-8">
      <div className="surface w-full max-w-lg p-8">
        <p className="text-xs uppercase tracking-[0.25em] text-muted">Create account</p>
        <h1 className="mt-4 text-3xl font-bold text-ink">Join eMessenger</h1>
        <form className="mt-8 grid gap-4 md:grid-cols-2" onSubmit={handleSubmit}>
          <input value={username} onChange={(e) => setUsername(e.target.value)} className="field md:col-span-2" placeholder="Username" />
          ...
          <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="field md:col-span-2" placeholder="Password" />
